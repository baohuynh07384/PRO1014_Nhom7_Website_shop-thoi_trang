    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <form action="/?url=ClientHomeController/updateAccount" enctype="multipart/form-data" method="POST"
                    id="updateAccountForm">
                    <input type="hidden" name="user_id" value="<?= $_SESSION['user']['id']; ?>">
                    <div class="row">
                        <div class="col-sm-3"><img src="<?= PUBLIC_URL . $data["image"] ?>" alt="..." class="img-thumbnail"
                                width="100%" ></div>
                        <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" placeholder="Enter email"
                                    name="email" class="error" value="<?= $data['email'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
