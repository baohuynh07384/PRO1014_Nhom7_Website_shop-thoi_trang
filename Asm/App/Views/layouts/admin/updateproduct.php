...
<div class="content-wrapper">
    ...
    <form method="post" class="container-fluid" enctype="multipart/form-data" action="/?url=ProductController/update/<?= $data['product'][0]['id']  ?>">
            ...
            <div class="card-body row">
                <div class="right col-xl-7">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên sản phẩm" value="<?= $data['product'][0]['proName']  ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="price" class="form-control" id="exampleInputPassword1" placeholder="Nhập giá" value="<?= $data['product'][0]['price']  ?>">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="qty" class="form-control" id="exampleInputPassword1" placeholder="Nhập số lượng" value="<?= $data['product'][0]['quantity']  ?>">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="category" class="form-control select2" style="width: 100%;">
                                ...
                                foreach ($data['category'] as $item) : ?>
                                    <option value="<?= $item['id'] ?>" <?= ($item['id'] == $data['product'][0]['cateId']) ? 'selected' : '' ?>><?= $item['name'] ?></option>
                                    <?php
                                endforeach ?>;
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" name="image[]" value="<?= $item['path'] ?>" class="custom-file-input" id="exampleInputFile" accept="images/*"  onchange="updateFileName(this)">
